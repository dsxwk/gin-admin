...
type UserDepartments struct {
	...
	UserId       int64       `gorm:"column:user_id;not null;default:0;type:int(10) unsigned;comment:用户id" json:"userId" form:"userId"`
	...
	IsMain       int64       `gorm:"column:is_main;not null;default:2;type:tinyint(3) unsigned;comment:是否是主部门 1=是 2=否" json:"isMain" form:"isMain"`
