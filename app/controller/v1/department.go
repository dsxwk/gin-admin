...
// @Success 200 {object} errcode.SuccessResponse{data=request.PageData{list=[]model.Department}} "成功"
// @Failure 400 {object} errcode.ArgsErrorResponse "参数错误"
// @Failure 500 {object} errcode.SystemErrorResponse "系统错误"
// @Router /api/department [get]
func (s *DepartmentController) List(c *gin.Context) {
	var (
...
// @Success 200 {object} errcode.SuccessResponse{data=model.Department} "成功"
// @Failure 400 {object} errcode.ArgsErrorResponse "参数错误"
// @Failure 500 {object} errcode.SystemErrorResponse "系统错误"
// @Router /api/department/{id} [get]
func (s *DepartmentController) Detail(c *gin.Context) {
	var (
		ctx = c.Request.Context()
		req request.Department
	)
...
// @Description 部门创建
// @Param token header string true "认证Token"
// @Param data body request.DepartmentCreate true "创建参数"
// @Success 200 {object} errcode.SuccessResponse{data=model.Department} "成功"
// @Failure 400 {object} errcode.ArgsErrorResponse "参数错误"
// @Failure 500 {object} errcode.SystemErrorResponse "系统错误"
// @Router /api/department [post]
func (s *DepartmentController) Create(c *gin.Context) {
	var (
		ctx = c.Request.Context()
		req request.Department
	)
...
// @Param token header string true "认证Token"
// @Param id path int true "ID"
// @Param data body request.DepartmentUpdate true "更新参数"
// @Success 200 {object} errcode.SuccessResponse "成功"
// @Failure 400 {object} errcode.ArgsErrorResponse "参数错误"
// @Failure 500 {object} errcode.SystemErrorResponse "系统错误"
// @Router /api/department/{id} [put]
func (s *DepartmentController) Update(c *gin.Context) {
	var (
		ctx  = c.Request.Context()
		data map[string]any
		req  request.Department
...
func (s *DepartmentController) Delete(c *gin.Context) {
	var (
		ctx = c.Request.Context()
		req request.Department
	)
