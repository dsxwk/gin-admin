...
INSERT INTO `dict` VALUES (2, 1, 'gender', '男', '1', 1, 0, '{\"a\": \"111\", \"b\": \"222\"}', '测试', '2025-06-06 21:49:00', '2026-08-27 10:55:30', NULL);
...
CREATE TABLE `operator_log`  (
  ...
  `header` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '请求头',
...
INSERT INTO `operator_log` VALUES (56, '127.0.0.1', 'POST', '{\"Accept\":[\"*/*\"],\"Accept-Encoding\":[\"gzip, deflate, br\"],\"Cache-Control\":[\"no-cache\"],\"Connection\":[\"keep-alive\"],\"Content-Length\":[\"270\"],\"Content-Type\":[\"application/json\"],\"Postman-Token\":[\"e2575d9d-1c44-493a-b9b1-a5d0b5b0b938\"],\"Token\":[\"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3ODkwMjY4MjAsImlkIjoxfQ.6qd2MlwAnkaNlx1iSXpyhH9NRQ9Ne0iiSSUiguznmJI\"],\"User-Agent\":[\"PostmanRuntime/2.5.0\"]}', '/api/v1/user', 'zh', '{\"gender\": 1, \"fullName\": \"test0910\", \"mainDept\": {\"departmentId\": 2}, \"nickname\": \"test0910\", \"password\": \"123456\", \"username\": \"test0910\", \"userDepts\": [{\"departmentId\": 2}]}', 1, '38c9477f-d638-441a-abe4-8c2da3bd2264', 200, 'PostmanRuntime/2.5.0', 136.0000, '2026-09-10 15:05:21', '2026-09-10 15:05:21', NULL);
INSERT INTO `operator_log` VALUES (57, '127.0.0.1', 'PUT', '{\"Accept\":[\"*/*\"],\"Accept-Encoding\":[\"gzip, deflate, br\"],\"Cache-Control\":[\"no-cache\"],\"Connection\":[\"keep-alive\"],\"Content-Length\":[\"278\"],\"Content-Type\":[\"application/json\"],\"Postman-Token\":[\"fbd10841-57f3-4a1f-b067-5e25708dbe6f\"],\"Token\":[\"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3ODkwMjY4MjAsImlkIjoxfQ.6qd2MlwAnkaNlx1iSXpyhH9NRQ9Ne0iiSSUiguznmJI\"],\"User-Agent\":[\"PostmanRuntime/2.5.0\"]}', '/api/v1/user/68', 'zh', '{\"gender\": 1, \"fullName\": \"test20260910\", \"mainDept\": {\"departmentId\": 2}, \"nickname\": \"test20260910\", \"password\": \"123456\", \"username\": \"test0910\", \"userDepts\": [{\"departmentId\": 2}]}', 1, '29c43aba-629d-467c-a318-1425bf4c0cf9', 200, 'PostmanRuntime/2.5.0', 181.0000, '2026-09-10 15:05:33', '2026-09-10 15:05:33', NULL);
INSERT INTO `operator_log` VALUES (58, '127.0.0.1', 'DELETE', '{\"Accept\":[\"*/*\"],\"Accept-Encoding\":[\"gzip, deflate, br\"],\"Cache-Control\":[\"no-cache\"],\"Connection\":[\"keep-alive\"],\"Postman-Token\":[\"79000ca6-2a36-4f08-8e7e-61205ac944ff\"],\"Token\":[\"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3ODkwMjY4MjAsImlkIjoxfQ.6qd2MlwAnkaNlx1iSXpyhH9NRQ9Ne0iiSSUiguznmJI\"],\"User-Agent\":[\"PostmanRuntime/2.5.0\"]}', '/api/v1/user/68', 'zh', '{}', 1, '06f141f0-9693-4aba-a3d8-ebd33ec952af', 200, 'PostmanRuntime/2.5.0', 56.0000, '2026-09-10 15:05:42', '2026-09-10 15:05:42', NULL);
...
CREATE TABLE `role_permissions`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_role_id`(`role_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 683 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '角色权限表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `user` VALUES (2, '', 'test2', '李四1', 'ls@qq.com', '$2a$10$kycb2DM8CnubeoWABNPA1O2b0MrQQDqGsEZg8EuqK4G0a63EYDr.2', 'test2', 1, 1, 1, '2023-09-06 11:38:50', '2026-08-28 13:35:49', NULL);
...
INSERT INTO `user_departments` VALUES (13, 67, 2, 1, '2026-09-10 14:36:58', '2026-09-10 14:36:58', NULL);
INSERT INTO `user_departments` VALUES (15, 68, 2, 1, '2026-09-10 15:05:33', '2026-09-10 15:05:33', NULL);
