...
func (c *RabbitmqConsumer) Start[T ConsumerHandler](h T) {
...
func (c *RabbitmqConsumer) consumeLoop[T ConsumerHandler](h T) {
...
func (c *RabbitmqConsumer) handleMessage[T ConsumerHandler](msg amqp091.Delivery, h T) {
	maxRetry := h.Retry()
	retry := 0
	for {
