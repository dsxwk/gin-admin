...
func (m *MakeEnum) Name() string {
	return "make:enum"
}

func (m *MakeEnum) Description() string {
	return "枚举创建"
}

func (m *MakeEnum) Help() []base.CommandOption {
...
func init() {
	cli.Register(&MakeEnum{})
}

func (m *MakeEnum) generateFile(_make, file, desc string) {
